...
namespace GameEngine.Detail
{
    ...
    {
        public static readonly int NUM_LAYER = 5;

        public static readonly int LAYER_CAMERA = 0;
        public static readonly int LAYER_3D_OBJECT = 1;
        public static readonly int LAYER_EFFECT = 2;
        public static readonly int LAYER_2D_OBJECT = 3;
        public static readonly int LAYER_FADE = 4;
